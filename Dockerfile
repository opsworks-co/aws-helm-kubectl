...
FROM --platform=${BUILDPLATFORM} public.ecr.aws/docker/library/python:3.11.7-alpine${ALPINE_VERSION} as builder
...
FROM --platform=${BUILDPLATFORM} public.ecr.aws/docker/library/alpine:${ALPINE_VERSION}
